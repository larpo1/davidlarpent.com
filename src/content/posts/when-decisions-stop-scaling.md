...
description: The synthesis bottleneck that dashboards couldn't solve
draft: true
tags:
  - AI
  - decisions
...
I think there is. But it requires [rethinking how we build data systems](/posts/ai-data-architecture) and [what we expect AI to do for us](/posts/decision-systems).
